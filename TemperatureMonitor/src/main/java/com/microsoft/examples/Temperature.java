...
public class Temperature
{
  ...
  protected String dashboardUri;

  // Reads the configuration information for the Event Hub spout and dashboard
  protected void readConfig(String[] args) throws Exception {
    ...
    dashboardUri = properties.getProperty("dashboard.uri");
